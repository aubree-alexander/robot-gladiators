...
var fightOrSkip = function() {
    ...
    if (promptFight === "skip") {
        ...
        if (confirmSkip) {
            ...
            // subtract money frorm playerMoney for skipping
...
var fight = function(enemy) {
    ...
    while(playerInfo.health > 0 && enemy.health > 0) {
        ...
        if (isPlayerTurn) {
            ...
            console.log(
                playerInfo.name + ' attacked ' + enemy.name + '. ' + enemy.name + ' now has ' + enemy.heatlh + ' health remaining.'
            );
...
//function to end the entire game
    var endGame = function() {
        ...
        //if player has no more money than the high score, player has new high score
